  ...
  flake.nixosModules.flatpak = { ... }: {
    ...
    services.flatpak = {
      ...
      remotes = [
        ...
        { name = "flatpark";       location = "https://dl.flatpark.org/flatpark.flatpakrepo"; }
        { name = "freesmlauncher"; location = "https://flatpak.freesmlauncher.org/freesmlauncher.flatpakrepo"; }
      ];
